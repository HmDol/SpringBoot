...
public class Data {
	@Id //pk지정
	@SequenceGenerator(name="seq_data", sequenceName="seq_data", allocationSize=1) // 시퀀스 생성, 시퀀스 이름 : seq_board2
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="seq_data")//num컬럼에 자동으로 값 할당
	private int num;
